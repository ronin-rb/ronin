...
describe Ronin::CLI::Commands::Escape do
  ...
  describe "options" do
    ...
    describe "--quoted-printable" do
      ...
      it "must add :quoted_printable_escape to #method_calls" do
        expect(subject.method_calls.last).to eq(:quoted_printable_escape)
      end
    end
    ...
    describe "--perl" do
      ...
      it "must add :perl_escape to #method_calls" do
        expect(subject.method_calls.last).to eq(:perl_escape)
      end
    end
    ...
    describe "--sql" do
      ...
      it "must add :sql_escape to #method_calls" do
        expect(subject.method_calls.last).to eq(:sql_escape)
      end
    end
  end
end
