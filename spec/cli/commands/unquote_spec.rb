...
describe Ronin::CLI::Commands::Unquote do
  ...
  describe "options" do
    ...
    describe "--java" do
      ...
      it "must add :java_unquote to #method_calls" do
        expect(subject.method_calls.last).to eq(:java_unquote)
      end
    end
    ...
    describe "--nodejs" do
      ...
      it "must add :node_js_unquote to #method_calls" do
        expect(subject.method_calls.last).to eq(:node_js_unquote)
      end
    end
