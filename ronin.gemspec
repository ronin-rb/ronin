...
Gem::Specification.new do |s|
  ...
  s.executables = ["ronin", "ronin-add", "ronin-console", "ronin-database", "ronin-help", "ronin-install", "ronin-ip", "ronin-list", "ronin-uninstall", "ronin-update"]
  s.extra_rdoc_files = [
    "ChangeLog.md",
    "README.md"
  ]
  s.files = [
    ...
    "lib/ronin/engine.rb",
    "lib/ronin/engine/buildable.rb",
    "lib/ronin/engine/class_methods.rb",
    "lib/ronin/engine/deployable.rb",
    "lib/ronin/engine/engine.rb",
    "lib/ronin/engine/exceptions.rb",
    "lib/ronin/engine/exceptions/deploy_failed.rb",
    "lib/ronin/engine/exceptions/not_built.rb",
    "lib/ronin/engine/exceptions/verification_failed.rb",
    "lib/ronin/engine/instance_methods.rb",
    "lib/ronin/engine/verifiable.rb",
    ...
    "lib/ronin/rpc/exceptions/invalid_response.rb",
    ...
    "lib/ronin/ui/command_line/commands/ip.rb",
    ...
    "spec/engine/classes/buildable_class.rb",
    "spec/engine/classes/deployable_class.rb",
    "spec/engine/classes/engine_class.rb",
    "spec/engine/classes/verifiable_class.rb",
